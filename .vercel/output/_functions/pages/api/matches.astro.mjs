...
import { c as calculate1v1Elo, a as calculateTeamElo, b as calculateFfaElo } from '../../chunks/elo_CBX70JZL.mjs';
export { renderers } from '../../renderers.mjs';

const POST = async ({ request, locals }) => {
  try {
    const body = await request.json();
    const { matchType, participants } = body;
    ...
    const eloChanges = /* @__PURE__ */ new Map();
    if (matchType === "1v1") {
